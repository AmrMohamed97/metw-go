...
part of 'delegate_info_data_source.dart';
...
class _DelegateInfoDataSource implements DelegateInfoDataSource {
  _DelegateInfoDataSource(this._dio, {this.baseUrl, this.errorLogger});
