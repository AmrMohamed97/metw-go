...
part 'fourth_step_data_source.g.dart';

@RestApi(baseUrl: EndPoints.baseUrl)
@injectable
abstract class FourthStepDataSource {
  @factoryMethod
  factory FourthStepDataSource(Dio dio) = _FourthStepDataSource;

  @POST(EndPoints.registerStep5)
  @MultiPart()
