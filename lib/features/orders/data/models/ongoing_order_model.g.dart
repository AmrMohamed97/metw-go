...
OngoingOrderModel _$OngoingOrderModelFromJson(Map<String, dynamic> json) =>
    OngoingOrderModel(
      ...
      pointTabs: (json['point_tabs'] as List<dynamic>?)
          ?.map((e) => PointTabModel.fromJson(e as Map<String, dynamic>))
          .toList(),
      activePointIndex: (json['active_point_index'] as num?)?.toInt(),
...
PointTabModel _$PointTabModelFromJson(Map<String, dynamic> json) =>
    PointTabModel(
...
Map<String, dynamic> _$PointTabModelToJson(PointTabModel instance) =>
    <String, dynamic>{
