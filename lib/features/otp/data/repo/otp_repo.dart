...
abstract class OtpRepo {
  Future<Either<Failure, VerifyOtpOutModel>> verifyOtp(VerifyOtpInputModel inputModel);
  Future<Either<Failure, ResendOtpOutModel>> resendOtp(ResendOtpInputModel inputModel);
}
