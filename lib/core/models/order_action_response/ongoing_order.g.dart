...
part of 'ongoing_order.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

OngoingOrder _$OngoingOrderFromJson(Map<String, dynamic> json) => OngoingOrder(
  ...
  pointTabs: (json['point_tabs'] as List<dynamic>?)
      ?.map((e) => PointTab.fromJson(e as Map<String, dynamic>))
      .toList(),
  activePointIndex: json['active_point_index'] as num?,
...
Map<String, dynamic> _$OngoingOrderToJson(OngoingOrder instance) =>
    <String, dynamic>{
      'mode': instance.mode,
      ...
      'point_tabs': instance.pointTabs,
      'active_point_index': instance.activePointIndex,
